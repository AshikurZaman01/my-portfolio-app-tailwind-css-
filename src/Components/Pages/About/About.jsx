        ...
        <div>
            <section className="py-8" id="aboutme">
                <div className="container m-auto px-4">
                    ...
                    <div className="w-[85%] m-auto mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white">
